      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-12">
          ...
          <section className="grid md:grid-cols-3 gap-8">
            <h2 className="text-[#38a13b] dark:text-[#5ccb5f] font-mono text-sm tracking-widest uppercase font-bold">The Goal</h2>
          ...
          <section className="grid md:grid-cols-3 gap-8 border-t border-gray-100 dark:border-white/5 pt-10">
            <h2 className="text-[#38a13b] dark:text-[#5ccb5f] font-mono text-sm tracking-widest uppercase font-bold">Data We Collect</h2>
            <div className="md:col-span-2 space-y-4">
              <div>
                <h3 className="text-gray-900 dark:text-white font-bold mb-1">Basic Info</h3>
                <p>Your name, email, and social links (like GitHub/LinkedIn) when you sign up for our workshops or hackathons.</p>
              </div>
              <div>
                <h3 className="text-gray-900 dark:text-white font-bold mb-1">Tech Profile</h3>
          ...
          <section className="grid md:grid-cols-3 gap-8 border-t border-gray-100 dark:border-white/5 pt-10">
            <h2 className="text-[#38a13b] dark:text-[#5ccb5f] font-mono text-sm tracking-widest uppercase font-bold">How We Use It</h2>
            <div className="md:col-span-2">
          ...
          <section className="bg-green-50 dark:bg-[#5ccb5f]/5 p-8 rounded-3xl border border-green-100 dark:border-[#5ccb5f]/20">
            <h2 className="text-gray-900 dark:text-white font-bold mb-4">Your Control</h2>
            <p>
